           ...
           <div className="grid grid-cols-4 border-b border-black/10 bg-off-white">
              {Object.entries(TIERS).map(([key, tier]) => (
                ...
                >
                  ...
                  {activeTier === key && <m.div layoutId="tab-highlight-p4" className="absolute top-0 left-0 w-full h-1 bg-gold" />}
                </button>
              ))}
           </div>
                       ...
                       <div className="mt-auto bg-dark p-8 text-white rounded-sm relative overflow-hidden shadow-2xl">
                          ...
                          <div className="relative z-10 flex gap-8">
                             <div className="flex-grow">
                                <span className="font-mono text-[9px] text-gold-on-cream uppercase tracking-widest block mb-4 font-bold">The Solution</span>
                                   ...
                                   >
                                      <div className="p-6">
                                         ...
                                         <div className="bg-dark p-6 text-white rounded-sm mb-6 relative overflow-hidden">
                                            ...
                                            <span className="font-mono text-[9px] text-gold-on-cream uppercase tracking-widest block mb-3 font-bold relative z-10">The Solution</span>
