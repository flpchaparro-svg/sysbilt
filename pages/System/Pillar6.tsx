...
import TierVisual from '../../components/Pillar6/TierVisual';
import { TIERS } from '../../constants/pillar6Data'; 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 flex-1 content-center items-center">
            <div className="flex flex-col items-start max-w-3xl">
               ...
               <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1] lg:leading-[0.9] tracking-tighter text-dark mb-6 md:mb-10">
                 Team <span className="italic font-serif text-gold-on-cream drop-shadow-[0_0_20px_rgba(197,160,89,0.2)]">Training.</span>
               </h1>
      ...
      <section className="w-full px-6 md:px-12 lg:px-20 pt-24 pb-32 max-w-[1400px] mx-auto border-t border-dark/10">
        ...
        <div className="mb-16">
           ...
           <h2 className="font-serif text-4xl md:text-5xl lg:text-7xl text-dark leading-[0.95] tracking-tighter mb-6">
             Select your <span className="italic text-gold-on-cream font-serif">Situation.</span>
           </h2>
           ...
           <div className="grid grid-cols-4 border-b border-black/10 bg-off-white">
              {Object.entries(TIERS).map(([key, tier]) => (
                ...
                >
                  ...
                  {activeTier === key && <m.div layoutId="tab-highlight-p6" className="absolute top-0 left-0 w-full h-1 bg-gold" />}
                </button>
              ))}
           </div>
              ...
              <div className="w-1/3 border-r border-black/10 bg-off-white p-8 flex flex-col">
                 ...
                 <div className="mb-8 p-4 bg-white border border-black/5 rounded-sm">
                    <div className="flex gap-2 items-center mb-2">
                       <HelpCircle className="w-4 h-4 text-gold-on-cream" />
                 ...
                 <div className="space-y-3 flex-grow">
                    {currentTier.personas.map((p, idx) => (
                      ...
                      >
                         ...
                         {activePersonaIndex === idx && <ChevronRight className="w-4 h-4 ml-auto text-gold-on-cream" />}
                      </button>
                    ))}
                 </div>
                    ...
                    <ul className="space-y-2">
                      {currentTier.specs.map((spec, i) => (
                        <li key={i} className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-wide text-black/60">
                          <CheckCircle className="w-3 h-3 text-gold-on-cream" />
                          {spec}
                        </li>
                      ))}
                    </ul>
                       ...
                       <div className="mt-auto bg-dark p-8 text-white rounded-sm relative overflow-hidden shadow-2xl">
                          ...
                          <div className="relative z-10 flex gap-8">
                             <div className="flex-grow">
                                <span className="font-mono text-[9px] text-gold-on-cream uppercase tracking-widest block mb-4 font-bold">The Fix</span>
                    ...
                    >
                      <div className="p-4 space-y-2">
                         ...
                         <div className="mb-6 p-4 bg-white border border-black/5 rounded-sm">
                            <p className="font-sans text-sm text-black/70 leading-relaxed">
                               <strong className="text-gold-on-cream block mb-1 font-bold uppercase text-[9px] tracking-widest">Is this you?</strong>
                               {tier.summary}
                            </p>
                         </div>
                               ...
                               <AnimatePresence>
                                 {isPersonaExpanded && (
                                   <m.div
                                     ...
                                     className="border-t border-gold/20 bg-white"
                                   >
                                      <div className="p-6">
                                         {/* Pain */}
                                         <div className="mb-6">
                                         ...
                                         <div className="bg-dark p-6 text-white rounded-sm mb-6 relative overflow-hidden">
                                            <div className="absolute top-0 right-0 w-24 h-24 bg-gold/20 rounded-full blur-2xl" />
                                            <span className="font-mono text-[9px] text-gold-on-cream uppercase tracking-widest block mb-3 font-bold relative z-10">The Fix</span>
