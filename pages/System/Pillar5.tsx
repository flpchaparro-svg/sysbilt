...
import TierVisual from '../../components/Pillar5/TierVisual';
import { TIERS } from '../../constants/pillar5Data';
           ...
           <div className="grid grid-cols-4 border-b border-black/10 bg-off-white">
              {Object.entries(TIERS).map(([key, tier]) => (
                ...
                >
                  ...
                  {activeTier === key && <m.div layoutId="tab-highlight" className="absolute top-0 left-0 w-full h-1 bg-gold" />}
                </button>
              ))}
           </div>
