#!/usr/bin/env node
/**
 * Generate Built to Sell chapter opener covers (SVG) and hub OG card.
...
const OUT = path.join(ROOT, 'public/images/built-to-sell/chapters')
const HUB_OUT = path.join(ROOT, 'public/images/built-to-sell')
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="${W}" height="${H}" role="img">
  ...
  <text x="600" y="280" text-anchor="middle" font-family="Georgia,serif" font-size="72" fill="${CREAM}" font-weight="500">Built to Sell</text>
  ...
  <text x="600" y="400" text-anchor="middle" font-family="Georgia,serif" font-size="22" fill="${CREAM}" opacity="0.75" font-style="italic">How online stores really work now</text>
  <text x="600" y="480" text-anchor="middle" font-family="ui-monospace,monospace" font-size="13" fill="${GOLD}" font-weight="700" letter-spacing="2">E-COMMERCE · SEARCH · AI</text>
</svg>`
}
