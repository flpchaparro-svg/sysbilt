...
const OUT = path.join(ROOT, 'public/images/built-to-multiply/chapters')
const HUB_OUT = path.join(ROOT, 'public/images/built-to-multiply')
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="${W}" height="${H}" role="img">
  ...
  <text x="600" y="400" text-anchor="middle" font-family="Georgia,serif" font-size="22" fill="${CREAM}" opacity="0.75" font-style="italic">How AI really works now</text>
