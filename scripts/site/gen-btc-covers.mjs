...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="${W}" height="${H}" role="img">
  ...
  <text x="600" y="400" text-anchor="middle" font-family="Georgia,serif" font-size="22" fill="${CREAM}" opacity="0.75" font-style="italic">How follow-up really works now</text>
  <text x="600" y="480" text-anchor="middle" font-family="ui-monospace,monospace" font-size="13" fill="${GOLD}" font-weight="700" letter-spacing="2">CRM · FOLLOW-UP · PIPELINE</text>
</svg>`
}
