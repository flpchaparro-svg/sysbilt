...
export const BTR_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
export const BTR_CONTENT_PAGES = BTR_RAW_CONTENT_PAGES

export function btrTotalPages(): number {
  return BTR_CONTENT_PAGES.length
}
