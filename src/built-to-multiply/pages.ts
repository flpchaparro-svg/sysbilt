...
export const BTM_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
export const BTM_CONTENT_PAGES = BTM_RAW_CONTENT_PAGES

export function btmTotalPages(): number {
  return BTM_CONTENT_PAGES.length
}
