...
export const BTC_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
/** Pages used by the measured book (same as raw for BTC). */
export const BTC_CONTENT_PAGES = BTC_RAW_CONTENT_PAGES

export function btcTotalPages(): number {
  return BTC_CONTENT_PAGES.length
}
