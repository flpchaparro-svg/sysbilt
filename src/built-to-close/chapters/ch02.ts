...
export const ch02Pages: BtwPage[] = [
  ...
  flow(
    ...
    ...section(
      ...
      ...p('Underneath every CRM ever built sit four ideas, and once you hold them, no demo can confuse you again.'),
      ...p('A contact is a person: name, details, and everything ever known about them, in one place. A company groups the contacts who belong together, so the three people you deal with at one client read as one relationship, not three strangers. A deal is a piece of potential work moving toward a yes or a no: the bathroom renovation being quoted, the retainer being discussed, each with a value and a stage. And an activity is anything that happened: the call, the email, the meeting, the note, stamped to the contact and the deal it belongs to.'),
      ...p('That is the whole machine. Contacts and companies are the memory of who. Deals are the memory of what might happen. Activities are the memory of what did. Every feature in chapter five is just a faster way of feeding or reading those four things, and every button in every CRM on earth maps back to them.'),
      {
        type: 'diagram',
        id: 'btc-ch02-four-words',
        caption: 'The four words that matter. CONTACT, COMPANY, DEAL, ACTIVITY, each with a one-line meaning. Everything else is a faster way to feed or read these.',
      },
    ),
  ),
  flow(
