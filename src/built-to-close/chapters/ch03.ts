...
export const ch03Pages: BtwPage[] = [
  opener({
    ...
    subtitle:
      'Built well, it is the most honest page in the business: one glance tells you what is coming, what is stuck, and what needs a call today.',
  }),
  flow(
    ...p(
  ...
  flow(
    ...section(
      ...
      ...p(
        'A pipeline\'s stages should describe what actually happens to a deal in your business, in the words you already use. Not a textbook\'s funnel, yours. For most businesses that shape is familiar: a new enquiry arrives, it gets qualified with a conversation, something is scoped or visited, a quote or proposal goes out, a decision gets chased, and it lands as won or lost. Five to seven stages, named plainly.',
        'The two ways pipelines die are the two ways owners over-think this. Too many stages, twelve micro-steps mapping every possible wobble, and updating the board becomes admin, so nobody does, and the board starts lying within a month. Too few, three vague zones, and the board tells you nothing you did not already feel. The test: each stage should represent a real change in the deal\'s situation, something you would mention if a colleague asked how that one is going.',
      ),
      {
        type: 'diagram',
        id: 'btc-ch03-too-many-few',
        caption:
          'Too many, too few. LEFT (crossed): twelve cramped micro-stages, tagged "nobody updates it". RIGHT (crossed): three vague zones, tagged "tells you nothing". CENTRE (gold): five to seven plain stages, tagged "a real change per stage".',
      },
      {
        type: 'diagram',
        id: 'btc-ch03-pipeline',
        caption:
          'A pipeline that mirrors reality. Horizontal board: NEW ENQUIRY, QUALIFIED, SCOPED, QUOTED, DECISION, WON/LOST, each with a one-line entry rule beneath (e.g. QUOTED: "the quote has been sent, not intended").',
      },
    ),
  ),
  flow(
