...
export function BtcCoverPage() {
  ...
  const shareUrl = `${SITE_ORIGIN}/guides/${BTC_META.slug}`
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#1a1a1a]/50 backdrop-blur-sm print:hidden">
          <div className="relative w-[90%] max-w-[320px] border border-[#1A1A1A] bg-[#FFF2EC] p-6 text-center">
            ...
            <div className="flex flex-col gap-3">
              <ShareButton url={shareUrl} title={BTC_META.title} mode="inline" variant="neumorphic" className="justify-center" />
              <button
                type="button"
                onClick={handlePrint}
      ...
      <div className="relative flex flex-1 flex-col justify-between p-[clamp(48px,7vw,80px)]">
        <div className="grid grid-cols-[1fr_auto_1fr] items-start gap-4">
          ...
          >
            ...
            Business Guides
            <br />
            <span style={{ color: BTW_TOKENS.goldOnCream }}>No. 03</span>
          </div>
        </div>
        ...
        <div className="my-auto">
          ...
          >
            / A FIELD GUIDE FOR TEAMS WHO CLOSE
          </div>
          <h1
          ...
          >
            Built
            <br />
            to <span className="italic" style={{ color: BTW_TOKENS.goldOnCream }}>Close</span>
          </h1>
...
export function BtcClosingPage() {
  return (
      ...
      <div className="relative flex flex-1 flex-col justify-between p-[clamp(48px,7vw,80px)]">
        ...
        <div className="my-auto">
          ...
          <h2 className="font-serif font-medium text-[clamp(38px,7vw,72px)] leading-[0.98] tracking-[-0.035em] text-[#FFF2EC] m-0 max-w-[16ch]">
            When you&apos;re ready for a pipeline that genuinely{' '}
            <span className="italic text-[#D4A84B]">closes</span>
          </h2>
          <p className="font-sans font-light text-[clamp(16px,1.8vw,20px)] leading-[1.6] text-[#FFF2EC]/80 max-w-[50ch] mt-8 mb-10">
            Start with a CRM Systems Review. A straight, no-obligation look at your follow-up and CRM against everything this
        ...
        <div className="pt-6 border-t border-[#FFF2EC]/14 flex justify-between flex-wrap gap-3 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-[#FFF2EC]/50">
          <span>Built to Close · No. 03</span>
