/** Chapter opener cover art — served from /public/images/built-to-work/chapters/ */
export const BTW_CHAPTER_COVERS: Record<
  number,
...
> = {
  ...
  2: {
    ...
    alt: 'A brass key and a padlock on a dark desk, lit warmly.',
  },
  3: {
  ...
  4: {
    ...
    alt: 'A small set of website page mockups laid out on a dark surface.',
  },
  5: {
    src: '/images/built-to-work/chapters/ch05.webp',
    alt: 'Small website interface components arranged like parts on a dark workbench.',
  },
  6: {
  ...
  7: {
    ...
    alt: 'A close-up of a fine mechanical gauge lit warmly on a dark background.',
  },
  8: {
  ...
  9: {
    ...
    alt: 'Fine gold lines radiating from a central point on a dark background.',
  },
  10: {
    src: '/images/built-to-work/chapters/ch10.webp',
    alt: 'A small seedling in warm light against a dark background.',
  },
  11: {
  ...
  12: {
    ...
    alt: 'An open notebook and fountain pen on a dark desk, lit warmly.',
  },
}
