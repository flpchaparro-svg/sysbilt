...
export const BTW_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
export const BTW_CONTENT_PAGES: BtwPage[] = BTW_RAW_CONTENT_PAGES

/** Cover (1) + content + closing (1). */
export function btwTotalPages(contentCount: number): number {
