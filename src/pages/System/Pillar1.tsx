 ...
 * animated version. direction 1 = card slides right-to-left (card 1); -1 = left-to-right (card 2).
 */
...
const Pillar1: React.FC<Pillar1Props> = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      <RouteHead
        title={SEO_META.pillar1.title}
        description={SEO_META.pillar1.description}
      ...
      <section aria-label="Hero" className="relative min-h-[700px] h-[100dvh] w-full flex flex-col overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full h-full flex flex-col relative z-10">
          ...
          >
            ...
            <span className="mx-2">/</span>
            <span className="text-dark/70">Websites</span>
          </nav>
