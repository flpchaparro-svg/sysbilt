...
import { pillar4Copy } from '../../constants/pillar4Copy';
      ...
      {mounted ? (
        <>
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 h-[2px] bg-gold w-[60vw] md:w-[800px] z-0 pointer-events-none"
          />
          <motion.div
...
const Pillar4: React.FC<Pillar4Props> = ({ onNavigate }) => {
  const pillarFAQs = getPillarFAQs('pillar4');
  const { hero, gap, solution, engine } = pillar4Copy;
  ...
  return (
    ...
    >
      ...
      <section aria-label="Hero" className="relative min-h-[700px] h-[100dvh] w-full flex flex-col overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full h-full flex flex-col relative z-10">
          ...
          >
            ...
            <span className="mx-2">/</span>
            <span className="text-dark/70">AI Assistants</span>
          </nav>
          <div className="flex justify-between items-center mb-8 md:mb-4 mt-4 relative z-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 flex-1 content-center items-center">
            <div className="flex flex-col items-start max-w-3xl">
              ...
              <p className="font-sans text-lg md:text-xl font-light leading-relaxed text-dark/70 max-w-2xl border-l-2 border-gold pl-6 mb-10 md:mb-8">
                {hero.sub}
              </p>
        ...
        <div className="relative w-full px-6 md:px-12 lg:px-20 z-20 mb-12 md:mb-16">
          <div className="max-w-[1400px] mx-auto">
            <div className="flex items-center gap-3 mb-6">
              <span className="font-mono text-xs font-bold uppercase tracking-[0.2em] text-gold-on-cream">
                {gap.eyebrow}
              </span>
            </div>
            ...
            <p className="font-sans text-lg md:text-xl text-dark/70 leading-relaxed max-w-2xl border-l-2 border-gold pl-6">
              {gap.sub}
            </p>
          </div>
        </div>
      ...
      <section id="engine" className="w-full px-6 md:px-12 lg:px-20 pb-24 max-w-[1400px] mx-auto border-t border-dark/10">
        <div className="pt-16 border-t border-dark/10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="font-mono text-xs font-bold uppercase tracking-[0.2em] text-gold-on-cream mb-6 md:mb-4 block">
              {engine.eyebrow}
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            {/* 3D ORBITAL WHEEL — P4 center, P1+P2+P3 orbiting (3 nodes at 120°) */}
            <div
            ...
            >
              ...
              >
                <div
                  className="absolute w-48 h-48 rounded-full bg-gold text-dark flex flex-col items-center justify-center shadow-[0_0_40px_rgba(197,160,89,0.4)]"
                  style={{ transform: "rotateX(-70deg)", transformStyle: "preserve-3d" }}
                >
                  <span className="font-mono text-[10px] tracking-widest opacity-80 mb-1 uppercase">Pillar 4</span>
                  <span className="font-serif font-bold text-xl text-center leading-tight uppercase">AI</span>
                </div>
                ...
                >
                  ...
                  <div className="absolute" style={{ transform: "rotate(240deg) translateY(-170px)", transformStyle: "preserve-3d" }}>
                    ...
                    >
                      <div
                        className="w-28 h-28 rounded-full flex flex-col items-center justify-center backdrop-blur-md"
                        style={{
                          transform: "rotate(-240deg) rotateX(-70deg)",
                          background: "linear-gradient(135deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.1) 100%)",
                          border: "1px solid rgba(255,255,255,0.6)",
                          boxShadow: "0 10px 30px -10px rgba(0,0,0,0.2), inset 0 0 20px rgba(255,255,255,0.8)"
                        }}
                  ...
                  {/* P3 Automation — bottom-right (120°) */}
                  <div className="absolute" style={{ transform: "rotate(120deg) translateY(-170px)", transformStyle: "preserve-3d" }}>
                    ...
                    >
                      <div
                        className="w-28 h-28 rounded-full flex flex-col items-center justify-center backdrop-blur-md"
                        style={{
                          transform: "rotate(-120deg) rotateX(-70deg)",
                          background: "linear-gradient(135deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.1) 100%)",
                          border: "1px solid rgba(255,255,255,0.6)",
                          boxShadow: "0 10px 30px -10px rgba(0,0,0,0.2), inset 0 0 20px rgba(255,255,255,0.8)"
                        }}
          ...
          >
            ...
            <GuidePathways
              legacyPath="/guides/ai-assistants"
              bookPath="/guides/built-to-think"
              bookTitle="Built to Think"
            />
          </section>
      ...
      <FAQSection
        ...
        subtitle="Common questions about AI training, security, and integration"
