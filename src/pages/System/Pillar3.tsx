...
import { pillar3Copy } from '../../constants/pillar3Copy';
...
const Pillar3: React.FC<Pillar3Props> = ({ onNavigate }) => {
  const pillarFAQs = getPillarFAQs('pillar3');
  const { hero, gap, solution, engine } = pillar3Copy;
  ...
  return (
    ...
    >
      <RouteHead
        title={SEO_META.pillar3.title}
        description={SEO_META.pillar3.description}
        canonical={SEO_META.pillar3.canonical}
      />
      <PillarServiceJsonLd pillarKey="pillar3" />
      {/* HERO */}
      <section aria-label="Hero" className="relative min-h-[700px] h-[100dvh] w-full flex flex-col overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full h-full flex flex-col relative z-10">
          ...
          >
            ...
            <span className="mx-2">/</span>
            <span className="text-dark/70">Automation</span>
          </nav>
      ...
      <section id="engine" className="w-full px-6 md:px-12 lg:px-20 pb-24 max-w-[1400px] mx-auto border-t border-dark/10">
        <div className="pt-16 border-t border-dark/10">
          ...
          >
            ...
            <GuidePathways
              legacyPath="/guides/automation"
              bookPath="/guides/built-to-run"
              bookTitle="Built to Run"
            />
          </section>
