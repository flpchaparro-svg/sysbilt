...
const STEPS = [
  {label: 'Media audited', detail: 'Heaviest offenders listed'},
  {label: 'Files cleaned', detail: 'Scoped pages or folders'},
  {label: 'Upload guide', detail: 'Plain rules for the team'},
  {label: 'Scope locked', detail: 'Eight pages or two folders'},
]

/** Once it ships: audit, clean, guide, scope. */
export function MediaCleanDeliverableMock() {
