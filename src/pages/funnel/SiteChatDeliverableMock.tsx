...
const STEPS = [
  {label: 'FAQs approved', detail: 'Up to twenty signed off'},
  {label: 'Chat live', detail: 'Branded on your site'},
  {label: 'Handoff tested', detail: 'Human door works'},
  {label: 'Guardrails on', detail: 'No inventing prices'},
]

/** Once it ships: FAQs, chat UI, handoff, guardrails. */
export function SiteChatDeliverableMock() {
