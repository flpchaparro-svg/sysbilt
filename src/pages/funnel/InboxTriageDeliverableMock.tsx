...
const STEPS = [
  {label: 'Triage map', detail: 'Categories that match your week'},
  {label: 'Rules setup', detail: 'In the mail tool you already use'},
  {label: 'Draft prompt pack', detail: 'For humans to run, not silent send'},
  {label: 'Team note', detail: 'How shared inboxes stay clean'},
]

/** Once it ships: map, rules, drafts, team note. */
export function InboxTriageDeliverableMock() {
