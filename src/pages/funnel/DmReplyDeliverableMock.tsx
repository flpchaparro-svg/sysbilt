...
const STEPS = [
  {label: 'Quick reply pack', detail: 'Approved answers'},
  {label: 'Handoff rules', detail: 'When a human must take it'},
  {label: 'Ownership note', detail: 'Who watches which inbox'},
  {label: 'Path tested', detail: 'You send a DM, we watch'},
]

/** Once it ships: replies, handoff, ownership, test. */
export function DmReplyDeliverableMock() {
