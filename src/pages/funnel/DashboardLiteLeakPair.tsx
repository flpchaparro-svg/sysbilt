...
/** Leak: scattered numbers beside a single weekly pane. */
export function DashboardLiteLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Ads look fine alone', 'Bookings in another tab', 'Reviews never sit beside spend'].map((row) => (
            <div
              key={row}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Leads this week', 'Bookings vs last', 'Reviews + campaign'].map((row, i) => (
            <motion.div
              key={row}
