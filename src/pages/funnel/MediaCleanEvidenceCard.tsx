...
/** Proof: heavy image weight drops into a clean, light file. */
export function MediaCleanEvidenceCard({business}: {business?: string | null}) {
    ...
    >
      ...
      <div className="p-4 md:p-5 grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="h-16 rounded-sm mb-2" style={{backgroundColor: `${FUNNEL_COLOURS.accent}28`}} />
        ...
        >
          ...
          <div className="h-16 rounded-sm mb-2" style={{backgroundColor: `${FUNNEL_COLOURS.gold}35`}} />
          <p className="font-sans text-[12px] font-semibold" style={{color: FUNNEL_COLOURS.ink}}>
            hero.webp
          </p>
