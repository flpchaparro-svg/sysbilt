...
const JOBS = [
  {label: 'Profile', detail: 'Maps looks finished'},
  {label: 'Reviews', detail: 'Ask path live'},
  {label: 'Missed call', detail: 'SMS catch-back'},
]

/** Proof: three clinic capture jobs light up together. */
export function BundleClinicEvidenceCard({business}: {business?: string | null}) {
