...
const STEPS = [
  {label: 'Enquiry in', detail: 'Form or email'},
  {label: 'Ack sent', detail: 'Seconds later, on-brand'},
  {label: 'Routed', detail: 'One inbox your team watches'},
]

/** Price-band mock: what the wired acknowledgement and route look like. */
export function EnquiryReplyDeliverableMock() {
