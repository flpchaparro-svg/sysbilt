...
const STEPS = [
  {label: 'Profile Fix', detail: 'Local presence cleaned'},
  {label: 'Review Engine', detail: 'Ask habit in place'},
  {label: 'Booking System', detail: 'Calendar wired'},
  {label: 'Book now tested', detail: 'End-to-end live'},
]

/** Once it ships: profile, reviews, booking, live test. */
export function BundleFrontDoorDeliverableMock() {
