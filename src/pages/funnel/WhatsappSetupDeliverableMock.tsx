...
const STEPS = [
  {label: 'Business profile', detail: 'On your number path'},
  {label: 'Label set', detail: 'Stages the team will use'},
  {label: 'Quick replies', detail: 'Approved answers in your voice'},
  {label: 'Routing note', detail: 'Who watches, who escalates'},
]

/** Once it ships: profile, labels, replies, routing. */
export function WhatsappSetupDeliverableMock() {
