...
const STEPS = [
  {label: 'Form design', detail: 'Mobile-first, branded'},
  {label: 'Field map', detail: 'Into CRM or structured inbox'},
  {label: 'Confirmation', detail: 'What the submitter sees next'},
  {label: 'Owner rules', detail: 'Who reads new intakes'},
]

/** Once it ships: fields, build, handoff. */
export function IntakeFormsDeliverableMock() {
