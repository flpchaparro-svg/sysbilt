...
const STEPS = [
  {label: 'ICP locked', detail: 'Who is worth chasing'},
  {label: 'Named list ready', detail: '50 to 100 fit prospects'},
  {label: 'Scripts written', detail: 'First touch and follow-up'},
  {label: 'Plan and booking path', detail: 'Order plus calendar door'},
]

/** Once it ships: ICP, list, scripts, plan. */
export function ClientFinderDeliverableMock() {
