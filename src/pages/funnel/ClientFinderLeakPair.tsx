...
/** Leak: spray list and hope beside a curated shortlist. */
export function ClientFinderLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Bought dump · 4,200 rows', 'No ICP locked', 'Script sounds like a bot'].map((row) => (
            <div
              key={row}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['ICP locked · who fits', '50 to 100 named prospects', 'Scripts + booking path'].map((row, i) => (
            <motion.div
              key={row}
