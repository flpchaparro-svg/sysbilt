...
const STEPS = [
  {label: 'Metric set', detail: 'Leads, bookings, reviews, campaigns'},
  {label: 'Board', detail: 'Simple layout, not a science fair'},
  {label: 'Source map', detail: 'Where each number comes from'},
  {label: 'Weekly ritual', detail: 'Ten-minute Monday check, written down'},
]

/** Once it ships: metrics, board, sources, ritual. */
export function DashboardLiteDeliverableMock() {
