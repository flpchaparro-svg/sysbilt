...
const STEPS = [
  {label: 'Profile Fix', detail: 'Maps looks finished'},
  {label: 'Review Engine', detail: 'Ask path in place'},
  {label: 'Missed-Call Text-Back', detail: 'SMS catches the ring-out'},
  {label: 'Handoff', detail: 'Who owns asks and calls'},
]

/** Once it ships: profile, reviews, missed-call, handoff. */
export function BundleClinicDeliverableMock() {
