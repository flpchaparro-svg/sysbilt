...
const STEPS = [
  {label: 'Sequence copy', detail: 'Two to four touches'},
  {label: 'Timing rules', detail: 'Sensible gaps'},
  {label: 'Stop rules', detail: 'Reply or opt-out ends it'},
  {label: 'Owner alert', detail: 'When a human should call'},
]

/** Once it ships: map, write, wire, stop. */
export function QuoteFollowupDeliverableMock() {
