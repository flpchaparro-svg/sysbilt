...
const THIN = ['Service page · vague offer', 'FAQ · buried in a PDF', 'Hours · three versions']
const CLEAR = ['Service page · plain offer', 'FAQ schema · on page', 'Hours · one source']

/** Leak: thin, conflicting facts beside citeable pages. */
export function GeoLeakPair() {
