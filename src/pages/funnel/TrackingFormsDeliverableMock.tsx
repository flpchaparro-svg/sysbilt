...
const STEPS = [
  {label: 'Events wired', detail: 'Up to five primary conversions'},
  {label: 'Forms routed', detail: 'Up to three destinations fixed'},
  {label: 'Watchlist ready', detail: 'What to check each week'},
  {label: 'Test proof', detail: 'A live test you can see'},
]

/** Once it ships: events, destinations, watchlist, test proof. */
export function TrackingFormsDeliverableMock() {
