...
/** Leak: hope-based reminders beside remind-then-rebook. */
export function NoshowRescueLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['No reminder sent', 'No-show · sigh only', 'Staff scramble to fill'].map((row) => (
            <div
              key={row}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['24h reminder', 'Morning nudge', 'Missed · rebook link'].map((row, i) => (
            <motion.div
              key={row}
