...
/** Leak: personal pocket chat beside a business WhatsApp desk. */
export function WhatsappSetupLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Owner phone only', 'Urgent and junk mixed', 'No handoff when away'].map((item) => (
            <div
              key={item}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Shared Business profile', 'Stage labels live', 'Quick replies approved'].map((item, i) => (
            <motion.div
              key={item}
