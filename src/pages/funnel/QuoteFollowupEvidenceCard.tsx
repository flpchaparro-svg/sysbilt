...
/** Proof: quote sits quiet in Sent, then a polite nudge sequence starts. */
export function QuoteFollowupEvidenceCard({business}: {business?: string | null}) {
