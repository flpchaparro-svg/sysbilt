...
/** Leak: three separate gaps beside one capture bundle. */
export function BundleClinicLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Profile unfinished', 'Nobody asks for reviews', 'Missed call → competitor'].map((row) => (
            <div
              key={row}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Profile Fix', 'Review Engine', 'Missed-Call Text-Back'].map((row, i) => (
            <motion.div
              key={row}
