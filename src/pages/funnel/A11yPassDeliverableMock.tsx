...
const STEPS = [
  {label: 'Critical scan', detail: 'Priority pages checked'},
  {label: 'Fix pass', detail: 'Contrast, labels, focus'},
  {label: 'Remainder note', detail: 'What a deeper audit would cover'},
  {label: 'Scope locked', detail: 'Priority pages at kickoff'},
]

/** Once it ships: scan, fix, report, scope. */
export function A11yPassDeliverableMock() {
