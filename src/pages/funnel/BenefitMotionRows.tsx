...
/** Site AI Chat: common FAQ answered in chat. */
function SiteChatCommonQuestionsVisual({reduce}: VisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center justify-between px-2.5">
      ...
      <div className="flex-1 flex flex-col justify-center gap-1.5 px-2.5">
        <motion.div
          className="self-end max-w-[85%] rounded-md border px-2 py-1"
          style={{borderColor: `${FUNNEL_COLOURS.ink}14`, backgroundColor: '#fff'}}
          initial={reduce ? false : {opacity: 0, y: 4}}
          whileInView={{opacity: 1, y: 0}}
          viewport={{once: true}}
        >
          <p className="font-sans text-[8px]" style={{color: FUNNEL_COLOURS.ink}}>Do you open Saturdays?</p>
        </motion.div>
        <motion.div
          className="self-start max-w-[90%] rounded-md border px-2 py-1"
          style={{borderColor: `${colors.teal}40`, backgroundColor: `${colors.teal}0C`}}
          initial={reduce ? false : {opacity: 0, y: 4}}
          whileInView={{opacity: 1, y: 0}}
          viewport={{once: true}}
          transition={{delay: 0.15}}
        >
          <p className="font-sans text-[8px]" style={{color: FUNNEL_COLOURS.ink}}>Yes, 9 to 1. Want the team?</p>
        </motion.div>
      </div>
    </div>
  )
...
/** Site AI Chat: handoff to a human. */
function SiteChatHandoffVisual({reduce}: VisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
      ...
      <div className="flex-1 flex items-center justify-center gap-2 px-2.5">
        ...
        <motion.div
          ...
          transition={{delay: 0.2}}
        >
          <p className="font-mono text-[6px] uppercase tracking-wide text-white/70 mb-1">Human</p>
          <p className="font-mono text-[8px] font-bold text-white">Alerted</p>
        </motion.div>
      </div>
    </div>
  )
...
/** Site AI Chat: on-brand voice. */
function SiteChatOnBrandVisual({reduce}: VisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-1.5 px-2.5">
        {['Approved FAQ set', 'Tone locked'].map((label, i) => (
          ...
          >
            ...
            <span className="font-mono text-[7px] font-bold uppercase tracking-wide" style={{color: colors.teal}}>Signed</span>
          </motion.div>
        ))}
      </div>
    </div>
...
/** Site AI Chat: optional Care after setup. */
function SiteChatOptionalCareVisual({reduce}: VisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-1.5 px-3">
        <motion.div
          ...
          viewport={{once: true}}
        >
          <span className="font-mono text-[7px] font-bold" style={{color: colors.teal}}>SETUP</span>
          <span className="font-sans text-[8px]" style={{color: FUNNEL_COLOURS.ink}}>Chat live · yours</span>
        </motion.div>
        <motion.div
          className="w-full rounded-sm border border-dashed px-2 py-1.5 text-center"
          ...
          transition={{delay: 0.2}}
        >
          <span className="font-mono text-[8px] font-bold uppercase tracking-wide" style={{color: FUNNEL_COLOURS.steel}}>Care optional</span>
        </motion.div>
      </div>
    </div>
  )
...
const SITE_CHAT_VISUALS = [
  SiteChatCommonQuestionsVisual,
  SiteChatHandoffVisual,
  SiteChatOnBrandVisual,
