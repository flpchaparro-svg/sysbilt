...
const STEPS = [
  {label: 'Home clear', detail: 'One headline, one ask'},
  {label: 'Contact obvious', detail: 'One click, every page'},
  {label: 'Services specific', detail: 'What you do, not a list'},
  {label: 'Mobile checked', detail: 'Tested on a real phone'},
]

/** Once it ships: home, contact, services, and mobile each land in turn. */
export function ConversionDeliverableMock() {
