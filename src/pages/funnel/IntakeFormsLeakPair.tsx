...
/** Leak: thread and PDF chaos beside one intake path. */
export function IntakeFormsLeakPair() {
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['intake.pdf · missing', 'Email thread · buried', 'CRM fields · empty'].map((row) => (
            <div
              key={row}
      ...
      >
        ...
        <div className="p-4 md:p-5 flex flex-col justify-center gap-2 min-h-[168px]">
          {['Form · branded', 'Fields · mapped', 'Owner · notified'].map((row, i) => (
            <motion.div
              key={row}
