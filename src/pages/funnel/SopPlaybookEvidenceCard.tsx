...
/** Proof: knowledge in one head vs a written playbook. */
export function SopPlaybookEvidenceCard({business}: {business?: string | null}) {
    ...
    >
      ...
      <div className="p-4 md:p-5 grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div
            className="h-16 rounded-sm mb-2 flex items-center justify-center"
            style={{backgroundColor: `${FUNNEL_COLOURS.accent}28`}}
          >
            <span className="font-mono text-[9px] font-bold uppercase tracking-wide" style={{color: FUNNEL_COLOURS.accent}}>
              One head
            </span>
          </div>
