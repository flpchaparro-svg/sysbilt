...
const STEPS = [
  {label: 'URL list locked', detail: 'Priority pages agreed at kickoff'},
  {label: 'Titles and H1s', detail: 'Clear, honest, not stuffed'},
  {label: 'Links wired', detail: 'Services, proof, contact connected'},
  {label: 'Before/after note', detail: 'A plain record you can keep'},
]

/** Once it ships: URL list, titles and H1s, links, and the before/after note each land in turn. */
export function OnpageDeliverableMock() {
