...
export const PROFILE_MESSAGING_COPY: FunnelProductCopy = {
  ...
  painLines: [
    ...
    'Staff invent replies on the fly, so tone and facts drift.',
  ...
  benefits: [
    {
      ...
      text: 'Even when you are busy, the thread does not go cold in the first minute.',
    },
    {
      title: 'Hours match reality',
      text: 'You are not "available" at 2am if nobody is watching. Settings tell the truth.',
    },
    {
      title: 'Staff share one voice',
      text: 'Canned replies keep facts and tone steady across the team.',
    },
    {
      title: 'Handoff is obvious',
...
export const ENQUIRY_REPLY_COPY = makeDraftCopy({
  ...
  h1Generic: 'Every enquiry should get a reply before they try someone else',
  sub: 'Profile messages, website forms, and the odd email all arrive in different places. We wire an instant acknowledgement and route the real conversation to one place you watch.',
  proofHeading: 'Speed of reply is the product',
  proofLead:
    'The first business to answer usually wins. A slow or missing ack feels like nobody is home, even when you are excellent at the work.',
  proofAfter:
    'We put a calm first reply on the channels you care about, then drop the lead where your team already works.',
  painHeading: 'Leads land. Nobody owns the first minute',
  painLines: [
    'Forms go to a shared inbox that nobody checks until evening.',
    'Profile messages and website enquiries live in different apps.',
    'You find out about a lead when they have already booked elsewhere.',
    'Staff copy-paste replies, so quality depends on who was free.',
  ],
  bridgeHeading: 'Instant ack, then a clean handoff',
  bridgeBody:
    "This isn't a full CRM rebuild. It's the first reply and the route into the system you already have. Profile, form, or both. Coming soon.",
  bridgeGaugeCaption: 'Seconds for the ack. Minutes for a human when the job needs one.',
  benefits: [
    {title: 'They hear from you immediately', text: 'The ack buys you time without looking unavailable.'},
    {title: 'One place to watch', text: 'Threads and forms stop scattering across five apps.'},
    {title: 'Tone stays yours', text: 'Templates match how you speak, not a generic bot voice.'},
    {title: 'Ready for CRM later', text: 'Clean routing makes CRM Rescue or Booking easier next.'},
  ],
  processSteps: [
    {label: 'Map', text: 'Which channels matter, where replies should land, who owns them.'},
    {label: 'Build', text: 'Ack copy, routing, and a test on each channel in scope.'},
    {label: 'Prove', text: 'You send a test enquiry. We watch it arrive where it should.'},
  ],
  stackItems: [
    {title: 'Channel scope', text: 'Up to two intake channels in the fixed price (for example profile + site form).'},
    {title: 'Ack templates', text: 'First reply for open hours and after hours.'},
    {title: 'Routing', text: 'Email, SMS alert, or CRM field, depending on what you already use.'},
    {title: 'Test pack', text: 'A short checklist so your team can re-test after staff changes.'},
  ],
  scopeLine: 'Up to two channels. Coming soon. Extra channels quoted same day.',
  price: '$1,250',
  priceLead: 'Fixed once scoped to your channels. Coming soon, not for sale today.',
  guarantee:
    'When this goes live: agreed channels send the ack and land in the agreed place, or we keep working at no extra cost until they do.',
  priceAnchor: 'One recovered enquiry usually covers this.',
  faqs: [
    comingSoonFaq,
    {
      q: 'How is this different from Missed-Call Text-Back?',
      a: 'Missed-Call is for phone rings you did not answer. This is for written enquiries: profile messages and forms.',
    },
  ],
  finalHeading: 'Be the first reply they get',
  finalLine: 'Ack in seconds. Handoff in one place. Coming soon.',
})
...
export const DRAFT_COPY_BY_SLUG: Record<string, FunnelProductCopy> = {
  'profile-messaging': PROFILE_MESSAGING_COPY,
  'enquiry-reply': ENQUIRY_REPLY_COPY,
