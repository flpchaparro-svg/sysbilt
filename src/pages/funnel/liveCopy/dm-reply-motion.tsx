/**
 * DM Reply System · benefit + stack motion visuals.
...
function DmAdsStopLeakVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center gap-2 px-2.5">
        ...
        >
          <p className="font-mono text-[6px] uppercase tracking-wide text-white/70 mb-1">First reply</p>
          <p className="font-mono text-[8px] font-bold text-white">Fast</p>
        </motion.div>
      </div>
    </div>
  )
...
function DmSharedOwnershipVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
...
function DmConsistentAnswersVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center justify-between px-2.5">
...
function DmPathToCrmVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
function DmQuickReplyPackStackVisual({reduce, play}: StackVisualProps) {
...
function DmHandoffStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
function DmOwnershipStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
function DmPathTestStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
export const DM_REPLY_BENEFIT_VISUALS = [
  DmAdsStopLeakVisual,
  DmSharedOwnershipVisual,
  DmConsistentAnswersVisual,
  DmPathToCrmVisual,
]

export const DM_REPLY_STACK_VISUALS = [
  DmQuickReplyPackStackVisual,
  DmHandoffStackVisual,
  DmOwnershipStackVisual,
  DmPathTestStackVisual,
]
