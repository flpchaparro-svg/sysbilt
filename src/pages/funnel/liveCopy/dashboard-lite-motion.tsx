...
function DashOnePlaceVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center gap-2 px-2.5">
        ...
        >
          <p className="font-mono text-[6px] uppercase tracking-wide text-white/70 mb-1">Board</p>
          <p className="font-mono text-[8px] font-bold text-white">One</p>
        </motion.div>
      </div>
    </div>
  )
...
function DashSpendOutcomesVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
...
function DashHonestScopeVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center justify-between px-2.5">
...
function DashCrmPathVisual({reduce}: BenefitVisualProps) {
  return (
    <div className="relative h-[118px] w-full rounded-sm overflow-hidden border border-dark/12 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
function DashMetricsStackVisual({reduce, play}: StackVisualProps) {
...
function DashBoardStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
      ...
      <div className="flex-1 flex items-center justify-center gap-1.5 px-2.5">
        ...
        >
          <p className="font-mono text-[8px] font-bold text-white">Clear</p>
        </motion.div>
      </div>
    </div>
  )
...
function DashSourceStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
function DashRitualStackVisual({reduce, play}: StackVisualProps) {
  const go = play || reduce
  return (
    <div className="w-full min-h-[88px] border border-dark/15 bg-white flex flex-col">
      <div className="h-6 shrink-0 border-b border-dark/10 bg-cream flex items-center px-2.5">
...
export const DASHBOARD_LITE_BENEFIT_VISUALS = [
  DashOnePlaceVisual,
  DashSpendOutcomesVisual,
  DashHonestScopeVisual,
  DashCrmPathVisual,
]

export const DASHBOARD_LITE_STACK_VISUALS = [
  DashMetricsStackVisual,
  DashBoardStackVisual,
  DashSourceStackVisual,
  DashRitualStackVisual,
]
