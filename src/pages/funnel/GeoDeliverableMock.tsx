...
const STEPS = [
  {label: 'Service pages citeable', detail: 'Clear offers and who you serve'},
  {label: 'FAQ schema placed', detail: 'Structured Q&A where it helps'},
  {label: 'Facts aligned', detail: 'Hours, locations, claims match'},
  {label: 'Plain handoff', detail: 'What to keep consistent later'},
]

/** Once it ships: pages, schema, facts, handoff. */
export function GeoDeliverableMock() {
