...
const STEPS = [
  {label: 'Conversion Pass', detail: 'Scoped pages ask clearly'},
  {label: 'Tracking Pack', detail: 'Events and destinations'},
  {label: 'Test enquiry', detail: 'You see a signal land'},
  {label: 'Watchlist', detail: 'What to check weekly'},
]

/** Once it ships: convert, track, prove, watch. */
export function BundleSpeedNextDeliverableMock() {
