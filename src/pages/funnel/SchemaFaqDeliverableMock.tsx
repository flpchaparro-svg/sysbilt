...
const STEPS = [
  {label: 'Services locked', detail: 'Priority services agreed at kickoff'},
  {label: 'FAQs written', detail: 'Real questions, plain answers'},
  {label: 'Schema valid', detail: 'FAQ markup checked and clean'},
  {label: 'Validation note', detail: 'A plain record you can keep'},
]

/** Once it ships: services, FAQs, schema, and the validation note each land in turn. */
export function SchemaFaqDeliverableMock() {
