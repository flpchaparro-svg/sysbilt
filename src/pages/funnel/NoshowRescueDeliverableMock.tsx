...
const STEPS = [
  {label: 'Reminder set', detail: 'Timing you approve'},
  {label: 'Rebook path', detail: 'Link that works'},
  {label: 'Owner alert', detail: 'Optional late free-up ping'},
  {label: 'Tested booking', detail: 'Dummy path proved'},
]

/** Once it ships: remind, recover, protect. */
export function NoshowRescueDeliverableMock() {
