...
/** Proof: personal phone chat vs business WhatsApp desk. */
export function WhatsappSetupEvidenceCard({business}: {business?: string | null}) {
    ...
    >
      ...
      <div className="p-4 md:p-5 grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="h-16 rounded-sm mb-2 flex flex-col justify-center gap-1 px-2" style={{backgroundColor: `${FUNNEL_COLOURS.accent}28`}}>
            <p className="font-mono text-[7px] uppercase tracking-wide" style={{color: FUNNEL_COLOURS.accent}}>
              Personal phone
            </p>
            <p className="font-sans text-[10px] font-semibold" style={{color: FUNNEL_COLOURS.ink}}>
              3 unread · no labels
            </p>
          </div>
        ...
        >
          ...
          <div className="h-16 rounded-sm mb-2 flex flex-col justify-center gap-1 px-2" style={{backgroundColor: `${FUNNEL_COLOURS.gold}35`}}>
            <p className="font-mono text-[7px] uppercase tracking-wide" style={{color: FUNNEL_COLOURS.goldDeep}}>
              Business profile
            </p>
            <p className="font-sans text-[10px] font-semibold" style={{color: FUNNEL_COLOURS.ink}}>
              New · Quote · Follow-up
