...
export const BTT_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
export const BTT_CONTENT_PAGES = BTT_RAW_CONTENT_PAGES

export function bttTotalPages(): number {
  return BTT_CONTENT_PAGES.length
}
