...
export function BttCoverPage() {
  ...
  const shareUrl = `${SITE_ORIGIN}/guides/${BTT_META.slug}`
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#1a1a1a]/50 backdrop-blur-sm print:hidden">
          <div className="relative w-[90%] max-w-[320px] border border-[#1A1A1A] bg-[#FFF2EC] p-6 text-center">
            ...
            <div className="flex flex-col gap-3">
              <ShareButton url={shareUrl} title={BTT_META.title} mode="inline" variant="neumorphic" className="justify-center" />
              <button
                type="button"
                onClick={handlePrint}
      ...
      <div className="relative flex flex-1 flex-col justify-between p-[clamp(48px,7vw,80px)]">
        <div className="grid grid-cols-[1fr_auto_1fr] items-start gap-4">
          ...
          >
            ...
            Business Guides
            <br />
            <span style={{ color: BTW_TOKENS.goldOnCream }}>No. 05</span>
          </div>
        </div>
        ...
        <div className="my-auto">
          ...
          >
            Built
            <br />
            to <span className="italic" style={{ color: BTW_TOKENS.goldOnCream }}>Think</span>
          </h1>
...
export function BttClosingPage() {
  return (
      ...
      <div className="relative flex flex-1 flex-col justify-between p-[clamp(48px,7vw,80px)]">
        ...
        <div className="my-auto">
          ...
          <h2 className="font-serif font-medium text-[clamp(38px,7vw,72px)] leading-[0.98] tracking-[-0.035em] text-[#FFF2EC] m-0 max-w-[18ch]">
            Put thinking where thinking{' '}
            <span className="italic text-[#D4A84B]">pays</span>
          </h2>
          <p className="font-sans font-light text-[clamp(16px,1.8vw,20px)] leading-[1.6] text-[#FFF2EC]/80 max-w-[50ch] mt-8 mb-10">
            Start with an AI Systems Review. A straight, no-obligation look at where AI would genuinely pay in your
            business, and where it would not. No pitch, no pressure — and no shortage of things we will tell you not to buy.
          </p>
          <Link
            to="/contact"
        ...
        <div className="pt-6 border-t border-[#FFF2EC]/14 flex justify-between flex-wrap gap-3 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-[#FFF2EC]/50">
          <span>Built to Think · No. 05</span>
          <span className="text-[#D4A84B]">Judgment stays human</span>
        </div>
      </div>
    </div>
  )
