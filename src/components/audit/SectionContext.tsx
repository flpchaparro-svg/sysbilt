...
export default function SectionContext({ text }: SectionContextProps) {
  ...
  if (treatAsMissing) {
    return (
      <div className="rounded-xl border border-dashed border-white/15 bg-white/[0.02] p-5 font-sans text-sm leading-relaxed text-white/75">
  ...
  return (
    <div className="space-y-3 border-l-2 border-gold-on-dark/50 pl-6 font-sans text-sm font-light leading-relaxed text-white/85 md:text-[15px] md:leading-[1.65]">
      {blocks.map((para, i) => (
