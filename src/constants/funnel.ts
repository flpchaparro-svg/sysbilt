...
export const FUNNEL_PRODUCT_LABELS: Record<FunnelProductCode, string> = {
  ...
  'profile-messaging': 'Profile Messaging Setup',
...
export const FUNNEL_PRODUCT_CATALOGUE: FunnelProductCard[] = [
  ...
  },
  {
    ...
    price: '$900',
    blurb: 'Google messaging on, hours set, canned replies, clear handoff. Coming soon.',
    status: 'soon',
    lane: 'soon',
    section: 'draft-local',
    href: '/go/profile-messaging',
  },
  {
    code: 'enquiry-reply',
    title: 'Enquiry Auto-Reply',
    price: '$1,250',
    blurb: 'Instant reply on profile and forms, routed to the right inbox. Draft.',
    status: 'soon',
    lane: 'soon',
    section: 'draft-local',
