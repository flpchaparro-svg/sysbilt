...
export const BSE_RAW_CONTENT_PAGES: BtwPage[] = [
  ...frontPages,
  ...ch01Pages,
  ...ch02Pages,
  ...ch03Pages,
...
export const BSE_CONTENT_PAGES = BSE_RAW_CONTENT_PAGES

export function bseTotalPages(): number {
  return BSE_CONTENT_PAGES.length
}
