import { BtwFigure } from '../../../built-to-work/components/BtwFigure'

/** Stub for FIG. 03.1 — full SVG pass in Stage 6. */
export function BtsProductPageAnatomyDiagram({ caption }: { caption: string }) {
  return (
    <BtwFigure fig="FIG. 03.1" caption={caption}>
      <div className="flex items-stretch gap-5 md:gap-8">
        ...
        <div className="flex flex-1 flex-col justify-between py-1">
          {[
            ['01', 'Promise', 'Product, name, who it is for.', false],
            ['02', 'Proof', 'Photos, details, reviews.', false],
            ['03', 'Price clarity', 'Full cost, shipping, delivery window.', false],
