  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1600px] mx-auto border-t border-l border-dark/10">
        {/*
          Mobile: 5 full-width rows. Tablet (md): symptoms left + cost/fix stacked right.
          Desktop (lg): row1 = problem ⅔ + graph ⅓ | row2 = three equal cols: symptoms | cost | fix.
        */}
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-3">
            
          {/* THE PROBLEM */}
          <div className="col-span-1 md:col-span-4 md:row-start-1 lg:col-span-2 lg:row-start-1 p-8 md:p-12 lg:p-16 border-r border-b border-dark/10 flex flex-col justify-center min-h-[300px] md:min-h-[400px] transition-colors duration-snap hover:bg-dark/5 group">
          ...
          {/* GRAPH CONTAINER */}
          <div className="col-span-1 md:col-span-2 md:row-start-1 md:col-start-5 lg:col-span-1 lg:row-start-1 lg:col-start-3 border-r border-b border-dark/10 bg-transparent flex items-center justify-center p-8">
          ...
          {/* SYMPTOMS */}
          <div className="col-span-1 md:col-span-3 md:row-span-2 md:row-start-2 md:col-start-1 lg:col-span-1 lg:row-span-1 lg:row-start-2 lg:col-start-1 p-8 md:p-12 border-r border-b border-dark/10 min-h-[300px] md:min-h-[400px] flex flex-col">
          ...
          <div
            ...
            className="col-span-1 md:col-span-3 md:row-start-2 md:col-start-4 lg:col-span-1 lg:row-start-2 lg:col-start-2 p-8 md:p-12 border-r border-b border-dark/10 bg-red-solid/5 min-h-[250px] md:min-h-0 lg:min-h-[400px] hover:bg-red-solid/10 transition-colors duration-snap relative overflow-hidden group flex flex-col justify-between"
          >
          ...
          <div
            ...
            onMouseLeave={handleGraphLeave}
            className="col-span-1 md:col-span-3 md:row-start-3 md:col-start-4 lg:col-span-1 lg:row-start-2 lg:col-start-3 p-8 md:p-12 border-r border-b border-dark/10 bg-dark text-white min-h-[250px] md:min-h-[400px] lg:min-h-[400px] flex flex-col justify-between border-l-2 border-l-gold"
          >
